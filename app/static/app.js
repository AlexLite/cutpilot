...
function applySimpleCopy() {
  ...
  document.querySelector('#instructions').innerHTML = `
    ...
    <div class="instruction-card"><h3>2. Выберите видео и напишите задачу</h3><p>Выберите файл в списке и опишите задачу обычными словами. Видео из AI_Cut по умолчанию обрабатывается без логотипа. Чтобы добавить логотип, напишите это явно.</p><p>Например: «сделай MP4» или «оставь фрагмент с 1.10 до 2.30».</p></div>
